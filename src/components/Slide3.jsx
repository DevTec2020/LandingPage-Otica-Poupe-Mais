    ...
    return(
        <div className="absolute inset-0 bg-brand-primary/10 text-white flex flex-col items-center justify-center text-center px-4 ">
            <h1 className="text-center text-3xl md:text-6xl font-bold lg:w-[100vh]">
                <span className="">Sua visão merece 
                <span className="text-brand-primary"> o melhor, sem pagar mais </span> por isso.</span>
            </h1>                     
            <h2 className="mt-5 md:text-2xl">Descubra ofertas exclusivas e receba seus óculos em 1 hora.</h2>
