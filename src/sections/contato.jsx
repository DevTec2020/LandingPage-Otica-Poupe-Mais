                ...
                <div className="max-w-7xl">
                        ...
                        <div className="p-6 rounded-2xl shadow-2xl bg-white text-gray-800 transition duration-300 hover:shadow-brand-primary/50" >
                            <div className="flex flex-col md:flex-row items-center">
                                ...
                                <div className="flex flex-col justify-center items-center w-full md:w-7/12 text-center md:text-left"> 
                                    ...
                                    <a 
                                        href="https://wa.me/5585992819050?text=Ol%C3%A1,%20vim%20do%20site%20e%20gostaria%20de%20agendar%20uma%20visita%20para%20conhecer%20as%20ofertas." 
                                        target='_blank'
                        ...
                        <div className="p-6 rounded-2xl shadow-2xl bg-white text-gray-800 transition duration-300 hover:shadow-brand-primary/50" >
                             <div className="flex flex-col md:flex-row items-center">
                                ...
                                <div className="flex flex-col justify-center items-center w-full md:w-7/12 text-center md:text-left"> 
                                    ...
                                    <a 
                                        href="https://wa.me/5585996406483?text=Ol%C3%A1,%20vim%20do%20site%20e%20gostaria%20de%20agendar%20uma%20visita%20para%20conhecer%20as%20ofertas." 
                                        target='_blank'
                                        rel="noopener noreferrer" 
                                        className="inline-flex items-center justify-center gap-2 px-6 py-2 mt-6 text-lg font-bold rounded-full text-white shadow-lg transition duration-300 transform hover:scale-105 
                    ...
                    <div className="mt-10">
                       <h3 className="text-2xl font-bold mb-4 text-white  uppercase">
                        ...
                        <a  href="https://wa.me/5585992819050?text=Ol%C3%A1,%20vim%20do%20site%20e%20gostaria%20de%20agendar%20uma%20visita%20para%20conhecer%20as%20ofertas%20de%20óculos." 
                            target='_blank' 
                            rel="noopener noreferrer"
